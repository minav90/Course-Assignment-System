class FacultyPreferencesController < ApplicationController
  ...
  def faculty_preference_params 
    params[:faculty_preference][:preference2_attributes][:note] = params[:faculty_preference][:preference1_attributes][:note]
    params[:faculty_preference][:preference3_attributes][:note] = params[:faculty_preference][:preference1_attributes][:note]
