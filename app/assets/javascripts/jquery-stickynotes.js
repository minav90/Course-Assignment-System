...
(function($) {
  ...
  StickyNote.prototype = {
		...
		initializeStickyNote : function(){
			link = $("<a href='#' class='addANoteLink'></a>");
		...
		callback : function(div){
			if(this.url.length>1){
				...
				return $.ajax({type : this.method_type,url : this.url,data : data,error : function(data){div.remove()},success : function(id){div[0].id=id}});
			}
		}
	}
})(jQuery)